...
_图注：随着架构规模增加，“Grep Tax”现象愈发显著。在 S5 规模（500 张表）下，TOON 比 YAML 多消耗 138% 的 Token；而在 S9 规模（10,000 张表）下，这一消耗激增至 740%。根本原因在于模型无法构建有效的细化模式（refinement patterns）来解析陌生的 TOON 语法。_
