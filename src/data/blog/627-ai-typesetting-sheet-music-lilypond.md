...
作者拿了两张图做实验，一张是古典片段，一张是 jazz lead sheet。这个设定很聪明，因为它刚好能测试两种不同难点：古典更吃音符与结构保真，jazz 则会额外考验和弦标记识别。

![古典乐谱原始测试图](../../assets/627/02-classical-input.jpg)

![Jazz 乐谱原始测试图](../../assets/627/03-jazz-input.jpg)
...
## 古典结果：认出了风格，但谱子基本另起炉灶

古典这组最能说明问题：模型并不是完全看不懂，相反，它已经能抓到 Bach 这种高层风格线索。可一旦你要求的是逐音符忠实转录，它就会从“识别”滑到“模仿”。

### Grok：看出了 Bach，但写出来的已经不是原曲

John 的评价很到位：Grok 生成的结果和原图几乎没有对应关系，甚至把一小节扩成了八小节。但它又确实写出了一种“像 Bach 的东西”。这正是最危险也最典型的地方——它不是瞎，而是太爱自作聪明。

![Grok 生成的古典乐谱结果](../../assets/627/04-bach-grok.png)

### ChatGPT：不止幻觉，还顺手写成了二声部

ChatGPT 这组更像一次一本正经的误创作。它没有忠实转录，而是输出了一段结构上更完整、但和原图对不上号的内容。你会感觉它不是在抄谱，而是在“参考原图后重新编”。

![ChatGPT 生成的古典乐谱结果](../../assets/627/05-bach-chatgpt.png)
...
## Jazz 结果更微妙：和弦经常对了，旋律还是飘了

Jazz 这组更值得看，因为它说明模型并不是所有层面都失手。和弦标记这种高层结构信息，它已经抓到不少；但只要落到旋律、节拍、调性这些需要严格贴图的细节，它还是会开始自由发挥。

### Grok：和弦比旋律靠谱

Grok 在这组里的表现很有代表性：和弦写得基本靠谱，甚至还认出了曲名和作者信息。但真正的旋律内容和原图已经偏得很远，说明它更像是在识别“这是什么歌”，而不是老实抄写每个音。

![Grok 生成的 jazz 乐谱结果](../../assets/627/06-jazz-grok.png)

### ChatGPT：相似度高一点，但还是忍不住改动结构

ChatGPT 这版比古典组稍微更接近原图一些，但依然不是保真转录。它改了调号、改了拍号，最后一小节甚至还出现了明显不合理的节拍长度。这类错法比完全胡写更麻烦，因为它“像”，却不真的“对”。

![ChatGPT 生成的 jazz 乐谱结果](../../assets/627/07-jazz-chatgpt.png)
